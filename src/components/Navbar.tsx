...
import { AppBar, Box, Toolbar, Tooltip, CircularProgress, useMediaQuery, Drawer, Typography, List, ListItem, ListItemText } from '@mui/material';
        ...
        <Box sx={{ flexGrow: 1 }}>
          <AppBar position='static' color='default'>
            <Toolbar>
              ...
              <Box sx={{ marginLeft: "auto" }} onClick={() => setOpen(true)}><FontAwesomeIcon icon={faBars} size='2x' className='navbarIcon' /></Box>
              <Drawer
                anchor="top"
                open={open}
                  ...
                  {isUserLoading ? (
                    ...
                    <>
                      ...
                      <Link href='/workspot/list' passHref>
                        <ListItem>
                          <Box sx={{ display: "block", width: "60px" }}>
                            <FontAwesomeIcon icon={faMapMarkedAlt} size='2x' className='drawerIcon' />
                          </Box>
                      ...
                      <Link href='/timecard/list' passHref>
                        <ListItem>
                          <Box sx={{ display: "block", width: "60px" }}>
                            <FontAwesomeIcon icon={faCalendarAlt} size='2x' className='drawerIcon' />
                          </Box>
